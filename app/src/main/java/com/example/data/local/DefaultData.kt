    ...
    fun getDefaultCourses(): List<Course> {
        return listOf(
            ...
            Course(
                ...
                endTime = "12:00",
                credits = 3.0,
                category = CourseCategory.CORE_MODULE,
            ...
            Course(
                ...
                endTime = "16:10",
                credits = 3.0,
                category = CourseCategory.PROFESSIONAL_MODULE,
                generalEduSubtype = GeneralEduSubtype.NONE,
                semester = "113-2",
                score = null,
                letterGrade = null,
            ...
            Course(
                ...
                generalEduSubtype = GeneralEduSubtype.CORE_SOCIAL,
                semester = "113-2",
                score = null,
                letterGrade = null,
                isCompleted = false,
            ...
            Course(
                ...
                credits = 2.0,
                category = CourseCategory.GENERAL_EDU,
                generalEduSubtype = GeneralEduSubtype.CORE_HUMANITIES,
                semester = "113-1",
                score = 84.0,
                letterGrade = "A-",
                isCompleted = true,
            ...
            Course(
                ...
                credits = 2.0,
                category = CourseCategory.GENERAL_EDU,
                generalEduSubtype = GeneralEduSubtype.LIBERAL_3,
                semester = "112-2",
                score = 86.0,
                letterGrade = "A",
                isCompleted = true,
            ...
            Course(
                ...
                credits = 2.0,
                category = CourseCategory.GENERAL_EDU,
                generalEduSubtype = GeneralEduSubtype.CHINESE,
                semester = "112-1",
                score = 88.0,
                letterGrade = "A",
                isCompleted = true,
